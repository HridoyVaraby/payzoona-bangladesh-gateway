        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-500 hover:text-payzoona-blue">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/services" className="text-gray-600 hover:text-payzoona-blue">Online Payment Gateway</Link></li>
              <li><Link to="/services" className="text-gray-600 hover:text-payzoona-blue">Cross-border Settlement</Link></li>
              <li><Link to="/services" className="text-gray-600 hover:text-payzoona-blue">Subscription Billing</Link></li>
              <li><Link to="/services" className="text-gray-600 hover:text-payzoona-blue">E-commerce Integrations</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/developers" className="text-gray-600 hover:text-payzoona-blue">API Documentation</Link></li>
              <li><Link to="/developers" className="text-gray-600 hover:text-payzoona-blue">SDKs</Link></li>
              <li><Link to="/developers" className="text-gray-600 hover:text-payzoona-blue">Sandbox</Link></li>
              <li><Link to="/developers" className="text-gray-600 hover:text-payzoona-blue">Integration Guides</Link></li>
            </ul>
          </div>
        </div>
